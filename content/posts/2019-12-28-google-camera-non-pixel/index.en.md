---
title: "Trying Google Camera on Non-Google Pixel Android Phones"
date: "2019-12-28"
description: "What's it like using the Google Camera app on phones other than the Google Pixel?"
categories:
- "Photography"
- "Tutorial"
image: "/posts/google-camera-non-pixel/GCam_thumb_facebook.png"
keywords:
- "Google Camera"
- "Android"
- "Photography"
...
{{< img src="GCam_thumb_facebook.png" width="800" alt="Result from Google Camera" caption="Result from Google Camera." >}}
...
> **Attention:**
> As this article is being updated (May 2021), Apple starting from iPhone 11 has introduced a similar feature called **Night Mode**. Additionally, almost all Android phone manufacturers have embedded similar features in their latest phones. Thus, the results obtained are not much different.
...
{{< img src="stanford-arcade-comp-s.png" width="800" alt="Example of photo results using HDR+" caption="Example of photo results using HDR+." >}}
...
{{< img src="HDR_burst.png" width="800" alt="Taking many images to be combined" caption="Taking many images to be combined." >}}
...
{{< img src="orig-and-mask-comp-s.png" width="800" alt="Portrait Mode Feature" caption="Portrait Mode Feature." >}}
...
{{< img src="Xiomi_GCam_Portrait-scaled.png" width="800" alt="Example of Portrait Mode result on a Xiaomi phone using Google Camera" caption="Example of Portrait Mode result on a Xiaomi phone using Google Camera. Left: a normal photo taken with HDR+ mode. Right: the blur/bokeh effect is obtained through AI processing on a phone with a single camera. The result is very satisfying." >}}
...
{{< img src="iphone_vs_pixel3.png" width="800" alt="iPhone photo result compared with Google Pixel 3 using Google Camera" caption="iPhone photo result compared with Google Pixel 3 using Google Camera." >}}
...
{{< img src="NightSight_1-scaled.png" width="800" alt="Example of Night Sight result using Google Camera on Xiaomi Redmi 5 Plus" caption="Example of Night Sight result using Google Camera on Xiaomi Redmi 5 Plus. Left: Photo taken using GCam HDR+. Right: Photo taken using Night Sight. The left result is more similar to the actual situation when seen directly by the eye, but the right one is brighter and clearer." >}}

{{< img src="NightSight_2.png" width="800" alt="Example of Night Sight result using Google Camera on Xiaomi Redmi 5 Plus" caption="Top: photo taken with HDR+ mode. Similar to what the eye sees. Bottom: Night Sight photo result. Taken handheld / without a tripod. The Night Sight mode result exceeds human vision." >}}

{{< img src="NightSight_3-scaled.png" width="800" alt="Example of Night Sight result using Google Camera on Xiaomi Redmi 5 Plus" caption="Left: Photo taken using GCam HDR+. Right: Photo taken using Night Sight. The results are not too different, but the Night Sight result is clearer and noise-free." >}}

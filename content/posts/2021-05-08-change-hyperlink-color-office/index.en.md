---
title: "Changing Hyperlink Color in Microsoft Word, Excel, and PowerPoint"
date: "2021-05-08"
description: "Hyperlinks or links in Microsoft Office are usually dark blue. What are the tricks to change them to another color?"
categories:
- "Office"
- "Tutorial"
keywords:
- "Microsoft Office"
- "Hyperlink in MS Office"
- "Microsoft Excel"
- "Excel Tutorial"
---

{{< img src="ms_office_hyperlink_banner.png" width="800" alt="Changing hyperlink color in Microsoft Office" caption="Changing hyperlink color in Microsoft Office." >}}
...
{{< img src="hyperlink-step-1.png" width="800" alt="Create a shape over the link text" caption="Create a shape over the link text." >}}
...
{{< img src="hyperlink-step-2.png" width="800" alt="Add link address to the shape" caption="Add link address to the shape." >}}
...
{{< img src="hyperlink-step-3.png" width="800" alt="Disguise the shape so the text is visible" caption="Disguise the shape so the text is visible." >}}

Well, it's quite simple, isn't it? If you're still having trouble, check out this [video tutorial](https://youtu.be/J-g0iPIGchQ) now! ❤️
